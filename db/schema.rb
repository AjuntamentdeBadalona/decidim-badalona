...
ActiveRecord::Schema.define(version: 20170607072957) do
  ...
  create_table "decidim_users", force: :cascade do |t|
    ...
    t.index ["email", "decidim_organization_id"], name: "index_decidim_users_on_email_and_decidim_organization_id", unique: true, where: "(deleted_at IS NULL)", using: :btree
